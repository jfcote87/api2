...
// Usage example:
//
//   import "github.com/jfcote87/api2/cloudsearch/v1"
//   ...
...
func (c *ProjectsIndexesSearchCall) Context(ctx context.Context) *ProjectsIndexesSearchCall {
	c.context_ = ctx
	return c
}
...
func (c *ProjectsIndexesDocumentsCreateCall) Context(ctx context.Context) *ProjectsIndexesDocumentsCreateCall {
	c.context_ = ctx
	return c
}
...
func (c *ProjectsIndexesDocumentsDeleteCall) Context(ctx context.Context) *ProjectsIndexesDocumentsDeleteCall {
	c.context_ = ctx
	return c
}
...
func (c *ProjectsIndexesDocumentsGetCall) Context(ctx context.Context) *ProjectsIndexesDocumentsGetCall {
	c.context_ = ctx
	return c
}
...
func (c *ProjectsIndexesDocumentsListCall) Context(ctx context.Context) *ProjectsIndexesDocumentsListCall {
	c.context_ = ctx
	return c
}
