...
// Usage example:
//
//   import "github.com/jfcote87/api2/dfareporting/v2.1"
//   ...
...
var baseURL *url.URL = &url.URL{Scheme: "https", Host: "www.googleapis.com", Path: "/dfareporting/v2.1/"}
...
func (r *AccountUserProfilesService) Insert(profileId int64, accountuserprofile *AccountUserProfile) *AccountUserProfilesInsertCall {
	return &AccountUserProfilesInsertCall{
		s:                  r.s,
		profileId:          profileId,
		accountuserprofile: accountuserprofile,
		caller_:            googleapi.JSONCall{},
...
func (c *AccountUserProfilesInsertCall) Do() (*AccountUserProfile, error) {
	var returnValue *AccountUserProfile
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
	})
...
func (r *ConnectionTypesService) Get(profileId int64, id int64) *ConnectionTypesGetCall {
	return &ConnectionTypesGetCall{
		s:             r.s,
		profileId:     profileId,
		id:            id,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/connectionTypes/{id}",
		context_:      googleapi.NoContext,
	}
}
...
func (c *ConnectionTypesGetCall) Do() (*ConnectionType, error) {
	var returnValue *ConnectionType
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"id":        strconv.FormatInt(c.id, 10),
	})
...
func (c *CreativeAssetsInsertCall) Upload(ctx context.Context, u googleapi.UploadCaller) *CreativeAssetsInsertCall {
	...
	case *googleapi.MediaUpload:
		c.pathTemplate_ = "/upload/dfareporting/v2.1/userprofiles/{profileId}/creativeAssets/{advertiserId}/creativeAssets"
	case *googleapi.ResumableUpload:
		c.pathTemplate_ = "/resumable/upload/dfareporting/v2.1/userprofiles/{profileId}/creativeAssets/{advertiserId}/creativeAssets"
	}
	return c
}
...
func (r *DirectorySitesService) Insert(profileId int64, directorysite *DirectorySite) *DirectorySitesInsertCall {
	return &DirectorySitesInsertCall{
		s:             r.s,
		profileId:     profileId,
		directorysite: directorysite,
		caller_:       googleapi.JSONCall{},
...
func (c *DirectorySitesInsertCall) Do() (*DirectorySite, error) {
	var returnValue *DirectorySite
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
	})
...
func (r *InventoryItemsService) Get(profileId int64, projectId int64, id int64) *InventoryItemsGetCall {
	return &InventoryItemsGetCall{
		...
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/projects/{projectId}/inventoryItems/{id}",
		context_:      googleapi.NoContext,
	}
}
...
func (c *InventoryItemsGetCall) Do() (*InventoryItem, error) {
	var returnValue *InventoryItem
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
...
func (r *InventoryItemsService) List(profileId int64, projectId int64) *InventoryItemsListCall {
	return &InventoryItemsListCall{
		s:             r.s,
		profileId:     profileId,
		projectId:     projectId,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/projects/{projectId}/inventoryItems",
		context_:      googleapi.NoContext,
	}
}
...
func (c *InventoryItemsListCall) InPlan(inPlan bool) *InventoryItemsListCall {
	c.params_.Set("inPlan", fmt.Sprintf("%v", inPlan))
	return c
}
...
func (c *InventoryItemsListCall) OrderId(orderId ...int64) *InventoryItemsListCall {
	for _, v_ := range orderId {
		c.params_.Add("orderId", fmt.Sprintf("%v", v_))
	}
	return c
}
...
func (c *InventoryItemsListCall) SiteId(siteId ...int64) *InventoryItemsListCall {
	for _, v_ := range siteId {
		c.params_.Add("siteId", fmt.Sprintf("%v", v_))
	}
	return c
}
...
func (c *InventoryItemsListCall) Do() (*InventoryItemsListResponse, error) {
	var returnValue *InventoryItemsListResponse
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"projectId": strconv.FormatInt(c.projectId, 10),
	})
...
func (r *MobileCarriersService) Get(profileId int64, id int64) *MobileCarriersGetCall {
	return &MobileCarriersGetCall{
		s:             r.s,
		profileId:     profileId,
		id:            id,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/mobileCarriers/{id}",
		context_:      googleapi.NoContext,
	}
}
...
func (c *MobileCarriersGetCall) Do() (*MobileCarrier, error) {
	var returnValue *MobileCarrier
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"id":        strconv.FormatInt(c.id, 10),
	})
...
func (r *OperatingSystemVersionsService) Get(profileId int64, id int64) *OperatingSystemVersionsGetCall {
	return &OperatingSystemVersionsGetCall{
		s:             r.s,
		profileId:     profileId,
		id:            id,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/operatingSystemVersions/{id}",
		context_:      googleapi.NoContext,
	}
}
...
func (c *OperatingSystemVersionsGetCall) Do() (*OperatingSystemVersion, error) {
	var returnValue *OperatingSystemVersion
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"id":        strconv.FormatInt(c.id, 10),
	})
...
func (r *OperatingSystemsService) Get(profileId int64, dartId int64) *OperatingSystemsGetCall {
	return &OperatingSystemsGetCall{
		s:             r.s,
		profileId:     profileId,
		dartId:        dartId,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/operatingSystems/{dartId}",
		context_:      googleapi.NoContext,
	}
}
...
func (c *OperatingSystemsGetCall) Do() (*OperatingSystem, error) {
	var returnValue *OperatingSystem
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"dartId":    strconv.FormatInt(c.dartId, 10),
	})
...
func (r *OrderDocumentsService) Get(profileId int64, projectId int64, id int64) *OrderDocumentsGetCall {
	return &OrderDocumentsGetCall{
		...
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/projects/{projectId}/orderDocuments/{id}",
		context_:      googleapi.NoContext,
	}
}
...
func (c *OrderDocumentsGetCall) Do() (*OrderDocument, error) {
	var returnValue *OrderDocument
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"projectId": strconv.FormatInt(c.projectId, 10),
		"id":        strconv.FormatInt(c.id, 10),
...
func (r *OrderDocumentsService) List(profileId int64, projectId int64) *OrderDocumentsListCall {
	return &OrderDocumentsListCall{
		s:             r.s,
		profileId:     profileId,
		projectId:     projectId,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/projects/{projectId}/orderDocuments",
		context_:      googleapi.NoContext,
	}
}
...
func (c *OrderDocumentsListCall) Do() (*OrderDocumentsListResponse, error) {
	var returnValue *OrderDocumentsListResponse
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"projectId": strconv.FormatInt(c.projectId, 10),
	})
...
func (r *OrdersService) Get(profileId int64, projectId int64, id int64) *OrdersGetCall {
	return &OrdersGetCall{
		...
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/projects/{projectId}/orders/{id}",
		context_:      googleapi.NoContext,
	}
}
...
func (r *OrdersService) List(profileId int64, projectId int64) *OrdersListCall {
	return &OrdersListCall{
		s:             r.s,
		profileId:     profileId,
		projectId:     projectId,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/projects/{projectId}/orders",
		context_:      googleapi.NoContext,
	}
}
...
func (c *OrdersListCall) Do() (*OrdersListResponse, error) {
	var returnValue *OrdersListResponse
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"projectId": strconv.FormatInt(c.projectId, 10),
	})
...
func (r *PlatformTypesService) Get(profileId int64, id int64) *PlatformTypesGetCall {
	return &PlatformTypesGetCall{
		s:             r.s,
		profileId:     profileId,
		id:            id,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/platformTypes/{id}",
		context_:      googleapi.NoContext,
	}
}
...
func (c *PlatformTypesGetCall) Do() (*PlatformType, error) {
	var returnValue *PlatformType
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"id":        strconv.FormatInt(c.id, 10),
	})
...
func (r *PostalCodesService) Get(profileId int64, code string) *PostalCodesGetCall {
	return &PostalCodesGetCall{
		s:             r.s,
		profileId:     profileId,
		code:          code,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/postalCodes/{code}",
		context_:      googleapi.NoContext,
	}
}
...
func (c *PostalCodesGetCall) Do() (*PostalCode, error) {
	var returnValue *PostalCode
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"code":      c.code,
	})
...
func (r *ProjectsService) Get(profileId int64, id int64) *ProjectsGetCall {
	return &ProjectsGetCall{
		...
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/projects/{id}",
		context_:      googleapi.NoContext,
	}
}
...
func (r *ProjectsService) List(profileId int64) *ProjectsListCall {
	return &ProjectsListCall{
		...
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/projects",
		context_:      googleapi.NoContext,
	}
}
...
func (r *RemarketingListSharesService) Get(profileId int64, remarketingListId int64) *RemarketingListSharesGetCall {
	return &RemarketingListSharesGetCall{
		s:                 r.s,
		profileId:         profileId,
		remarketingListId: remarketingListId,
		caller_:           googleapi.JSONCall{},
		params_:           make(map[string][]string),
		pathTemplate_:     "userprofiles/{profileId}/remarketingListShares/{remarketingListId}",
		context_:          googleapi.NoContext,
	}
}
...
func (c *RemarketingListSharesGetCall) Do() (*RemarketingListShare, error) {
	var returnValue *RemarketingListShare
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId":         strconv.FormatInt(c.profileId, 10),
...
func (r *RemarketingListSharesService) Patch(profileId int64, remarketingListId int64, remarketinglistshare *RemarketingListShare) *RemarketingListSharesPatchCall {
	return &RemarketingListSharesPatchCall{
		s:                    r.s,
		profileId:            profileId,
		remarketingListId:    remarketingListId,
		remarketinglistshare: remarketinglistshare,
		caller_:              googleapi.JSONCall{},
		params_:              make(map[string][]string),
		pathTemplate_:        "userprofiles/{profileId}/remarketingListShares",
		context_:             googleapi.NoContext,
	}
}
...
func (c *RemarketingListSharesPatchCall) Do() (*RemarketingListShare, error) {
	var returnValue *RemarketingListShare
	c.params_.Set("remarketingListId", fmt.Sprintf("%v", c.remarketingListId))
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
	})
	call := &googleapi.Call{
		...
		URL:     u,
		Params:  c.params_,
		Payload: c.remarketinglistshare,
		Result:  &returnValue,
	}
...
func (r *RemarketingListSharesService) Update(profileId int64, remarketinglistshare *RemarketingListShare) *RemarketingListSharesUpdateCall {
	return &RemarketingListSharesUpdateCall{
		s:                    r.s,
		profileId:            profileId,
		remarketinglistshare: remarketinglistshare,
		caller_:              googleapi.JSONCall{},
...
func (c *RemarketingListSharesUpdateCall) Do() (*RemarketingListShare, error) {
	var returnValue *RemarketingListShare
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
	})
...
func (r *RemarketingListsService) Get(profileId int64, id int64) *RemarketingListsGetCall {
	return &RemarketingListsGetCall{
		s:             r.s,
		profileId:     profileId,
		id:            id,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/remarketingLists/{id}",
		context_:      googleapi.NoContext,
	}
}
...
func (c *RemarketingListsGetCall) Do() (*RemarketingList, error) {
	var returnValue *RemarketingList
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"id":        strconv.FormatInt(c.id, 10),
	})
...
func (r *RemarketingListsService) Insert(profileId int64, remarketinglist *RemarketingList) *RemarketingListsInsertCall {
	return &RemarketingListsInsertCall{
		s:               r.s,
		profileId:       profileId,
		remarketinglist: remarketinglist,
		caller_:         googleapi.JSONCall{},
		params_:         make(map[string][]string),
		pathTemplate_:   "userprofiles/{profileId}/remarketingLists",
		context_:        googleapi.NoContext,
	}
}
...
func (c *RemarketingListsInsertCall) Do() (*RemarketingList, error) {
	var returnValue *RemarketingList
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
	})
...
func (r *RemarketingListsService) List(profileId int64, advertiserId int64) *RemarketingListsListCall {
	return &RemarketingListsListCall{
		s:             r.s,
		profileId:     profileId,
		advertiserId:  advertiserId,
		caller_:       googleapi.JSONCall{},
...
func (c *RemarketingListsListCall) Do() (*RemarketingListsListResponse, error) {
	var returnValue *RemarketingListsListResponse
...
func (r *RemarketingListsService) Patch(profileId int64, id int64, remarketinglist *RemarketingList) *RemarketingListsPatchCall {
	return &RemarketingListsPatchCall{
		s:               r.s,
		profileId:       profileId,
		id:              id,
		remarketinglist: remarketinglist,
...
func (c *RemarketingListsPatchCall) Do() (*RemarketingList, error) {
	var returnValue *RemarketingList
	c.params_.Set("id", fmt.Sprintf("%v", c.id))
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
...
func (r *RemarketingListsService) Update(profileId int64, remarketinglist *RemarketingList) *RemarketingListsUpdateCall {
	return &RemarketingListsUpdateCall{
		s:               r.s,
		profileId:       profileId,
		remarketinglist: remarketinglist,
		caller_:         googleapi.JSONCall{},
...
func (c *RemarketingListsUpdateCall) Do() (*RemarketingList, error) {
	var returnValue *RemarketingList
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
	})
...
func (r *TargetableRemarketingListsService) Get(profileId int64, id int64) *TargetableRemarketingListsGetCall {
	return &TargetableRemarketingListsGetCall{
		s:             r.s,
		profileId:     profileId,
		id:            id,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/targetableRemarketingLists/{id}",
		context_:      googleapi.NoContext,
	}
}
...
func (c *TargetableRemarketingListsGetCall) Do() (*TargetableRemarketingList, error) {
	var returnValue *TargetableRemarketingList
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
		"id":        strconv.FormatInt(c.id, 10),
	})
...
func (r *TargetableRemarketingListsService) List(profileId int64, advertiserId int64) *TargetableRemarketingListsListCall {
	return &TargetableRemarketingListsListCall{
		s:             r.s,
		profileId:     profileId,
		advertiserId:  advertiserId,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "userprofiles/{profileId}/targetableRemarketingLists",
		context_:      googleapi.NoContext,
	}
}
...
func (c *TargetableRemarketingListsListCall) Do() (*TargetableRemarketingListsListResponse, error) {
	var returnValue *TargetableRemarketingListsListResponse
	c.params_.Set("advertiserId", fmt.Sprintf("%v", c.advertiserId))
	u := googleapi.Expand(baseURL, c.pathTemplate_, map[string]string{
		"profileId": strconv.FormatInt(c.profileId, 10),
	})
