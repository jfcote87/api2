...
// Usage example:
//
//   import "github.com/jfcote87/api2/tasks/v1"
//   ...
...
var baseURL *url.URL = &url.URL{Scheme: "https", Host: "www.googleapis.com", Path: "/tasks/v1/"}
...
func (r *TasklistsService) Insert(tasklist *TaskList) *TasklistsInsertCall {
	return &TasklistsInsertCall{
		s:             r.s,
		tasklist:      tasklist,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "users/@me/lists",
		context_:      googleapi.NoContext,
	}
}
...
func (r *TasksService) Clear(tasklistid string) *TasksClearCall {
	return &TasksClearCall{
		s:             r.s,
		tasklistid:    tasklistid,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "lists/{tasklist}/clear",
		context_:      googleapi.NoContext,
	}
}
...
func (r *TasksService) Delete(tasklistid string, taskid string) *TasksDeleteCall {
	return &TasksDeleteCall{
		...
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "lists/{tasklist}/tasks/{task}",
		context_:      googleapi.NoContext,
	}
}
...
func (r *TasksService) Insert(tasklistid string, task *Task) *TasksInsertCall {
	return &TasksInsertCall{
		...
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "lists/{tasklist}/tasks",
		context_:      googleapi.NoContext,
	}
}
...
func (c *TasksInsertCall) Parent(parent string) *TasksInsertCall {
	c.params_.Set("parent", fmt.Sprintf("%v", parent))
	return c
}
...
func (c *TasksInsertCall) Previous(previous string) *TasksInsertCall {
	c.params_.Set("previous", fmt.Sprintf("%v", previous))
	return c
}
...
func (c *TasksListCall) CompletedMax(completedMax string) *TasksListCall {
	c.params_.Set("completedMax", fmt.Sprintf("%v", completedMax))
	return c
}
...
func (c *TasksListCall) CompletedMin(completedMin string) *TasksListCall {
	c.params_.Set("completedMin", fmt.Sprintf("%v", completedMin))
	return c
}
...
func (c *TasksListCall) DueMax(dueMax string) *TasksListCall {
	c.params_.Set("dueMax", fmt.Sprintf("%v", dueMax))
	return c
}
...
func (c *TasksListCall) DueMin(dueMin string) *TasksListCall {
	c.params_.Set("dueMin", fmt.Sprintf("%v", dueMin))
	return c
}
...
func (c *TasksListCall) ShowCompleted(showCompleted bool) *TasksListCall {
	c.params_.Set("showCompleted", fmt.Sprintf("%v", showCompleted))
	return c
}
...
func (r *TasksService) Move(tasklistid string, taskid string) *TasksMoveCall {
	return &TasksMoveCall{
		s:             r.s,
		tasklistid:    tasklistid,
		taskid:        taskid,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "lists/{tasklist}/tasks/{task}/move",
		context_:      googleapi.NoContext,
	}
}
