...
// Usage example:
//
//   import "github.com/jfcote87/api2/adsense/v1.4"
//   ...
...
var baseURL *url.URL = &url.URL{Scheme: "https", Host: "www.googleapis.com", Path: "/adsense/v1.4/"}
...
func (r *AccountsAlertsService) Delete(accountId string, alertId string) *AccountsAlertsDeleteCall {
	return &AccountsAlertsDeleteCall{
		s:             r.s,
		accountId:     accountId,
		alertId:       alertId,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "accounts/{accountId}/alerts/{alertId}",
		context_:      googleapi.NoContext,
	}
}
...
func (r *AccountsPaymentsService) List(accountId string) *AccountsPaymentsListCall {
	return &AccountsPaymentsListCall{
		s:             r.s,
		accountId:     accountId,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "accounts/{accountId}/payments",
		context_:      googleapi.NoContext,
	}
}
...
func (c *AccountsReportsGenerateCall) UseTimezoneReporting(useTimezoneReporting bool) *AccountsReportsGenerateCall {
	c.params_.Set("useTimezoneReporting", fmt.Sprintf("%v", useTimezoneReporting))
	return c
}
...
func (r *AdunitsService) GetAdCode(adClientId string, adUnitId string) *AdunitsGetAdCodeCall {
	return &AdunitsGetAdCodeCall{
		s:             r.s,
		adClientId:    adClientId,
		adUnitId:      adUnitId,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "adclients/{adClientId}/adunits/{adUnitId}/adcode",
		context_:      googleapi.NoContext,
	}
}
...
func (r *AlertsService) Delete(alertId string) *AlertsDeleteCall {
	return &AlertsDeleteCall{
		s:             r.s,
		alertId:       alertId,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "alerts/{alertId}",
		context_:      googleapi.NoContext,
	}
}
...
func (r *PaymentsService) List() *PaymentsListCall {
	return &PaymentsListCall{
		s:             r.s,
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "payments",
		context_:      googleapi.NoContext,
	}
}
