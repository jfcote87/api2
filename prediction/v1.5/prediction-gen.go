...
// Usage example:
//
//   import "github.com/jfcote87/api2/prediction/v1.5"
//   ...
...
var baseURL *url.URL = &url.URL{Scheme: "https", Host: "www.googleapis.com", Path: "/prediction/v1.5/"}
...
func (r *TrainedmodelsService) Analyze(id string) *TrainedmodelsAnalyzeCall {
	return &TrainedmodelsAnalyzeCall{
		...
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "trainedmodels/{id}/analyze",
		context_:      googleapi.NoContext,
	}
}
...
func (r *TrainedmodelsService) List() *TrainedmodelsListCall {
	return &TrainedmodelsListCall{
		...
		caller_:       googleapi.JSONCall{},
		params_:       make(map[string][]string),
		pathTemplate_: "trainedmodels/list",
		context_:      googleapi.NoContext,
	}
}
